...
export interface CreateExchangeRequest {
  from: string;
  to: string;
  address: string;  // Recipient address (ZEC address)
...
class ChangeNowClient {
  ...
  /**
   * Check if SOL and ZEC are supported
   */
  async verifySolZecSupport(): Promise<{ sol: boolean; zec: boolean }> {
