...
export const mixHistory = pgTable("mix_history", {
  ...
  zecReceived: numeric("zec_received", { precision: 18, scale: 9 }),
  exchangeRate: numeric("exchange_rate", { precision: 18, scale: 9 }),
...
export const feeLedger = pgTable("fee_ledger", {
  ...
  amount: numeric("amount", { precision: 18, scale: 9 }).notNull(),
  currency: text("currency").notNull(), // 'SOL', 'ZEC'
...
export const referralCodes = pgTable("referral_codes", {
  ...
  referrerRewardPercent: numeric("referrer_reward_percent", { precision: 5, scale: 2 }).default('5').notNull(),
